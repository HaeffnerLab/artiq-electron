...
class rigol():
	...
	def run(self, pulse_width_ej, pulse_delay_ej):
		...
		waveform_ej[:] = -1
		waveform_ej[np.int(self.pulse_delay_ej+1000.E-9/2E-9):np.int((self.pulse_delay_ej+self.pulse_width_ej+1000.E-9)/2E-9)] = 1
		ej_str = ",".join(map(str,waveform_ej))

#####
		period_reset = 2000.E-9
		waveform_reset = np.zeros(500)
		waveform_reset[:] = -1
		waveform_reset[10:490] = 1
