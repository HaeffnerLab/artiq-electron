...
class rigol():
	...
	def run(self, pulse_width_ao, pulse_delay_ao, pulse_width_ej, pulse_delay_ej, wait_time):
		...
		waveform_ao[:] = -1
		waveform_ao[np.int(self.pulse_delay_ej+self.pulse_width_ao/self.sampling_time):np.int((self.pulse_delay_ej+self.sampling_time*20+self.pulse_width_ao)/self.sampling_time)] = 1
...
# 		waveform_ao = np.zeros(samples)
# 		waveform_ao[:] = -1
# 		waveform_ao[np.int(self.pulse_delay_ej+90E-9/self.sampling_time):np.int((self.pulse_delay_ej+self.pulse_width_ej+90E-9)/self.sampling_time)] = 1

# 		# period_ao = 1000.E-9
# 		# waveform_ao = np.zeros(500)

# 		# waveform_ao[:] = -1
# 		# # waveform_ao[np.int((self.pulse_delay_ej+190E-9)/2E-9):np.int((self.pulse_delay_ej+self.pulse_width_ej+190E-9)/2E-9)] = 1
# 		# waveform_ao[np.int((self.pulse_delay_ej)/2E-9):np.int((self.pulse_delay_ej+self.pulse_width_ej)/2E-9)] = 1
...
# 		inst.write("SOURCE1:PERIOD {:.9f}".format(period_ao))
# 		# print(inst.ask("SOURCE2:PERIOD?"))
# 		inst.write("SOURCE1:VOLTage:UNIT VPP")
...
# 		waveform_ej = np.zeros(500)
# 		waveform_ej[:] = -1
# 		waveform_ej[np.int((self.pulse_delay_ej+90E-9)/2E-9):np.int((self.pulse_delay_ej+self.pulse_width_ej+90E-9)/2E-9)] = 1
# 		ej_str = ",".join(map(str,waveform_ej))
# 		# Channel 2



# 		inst2.write(":OUTPut2:LOAD INFinity")
# 		inst2.write("SOURCE2:PERIOD {:.9f}".format(period_ej))
# 		# print(inst.ask("SOURCE2:PERIOD?"))
# 		inst2.write("SOURCE2:VOLTage:UNIT VPP")
# 		inst2.write("SOURCE2:VOLTage {:.3f}".format(self.amplitude_ej))
# 		inst2.write("SOURCE2:VOLTage:OFFSet {:.3f}".format(self.offset_ej))

# 		inst2.write("SOURCE2:TRACE:DATA VOLATILE,"+ ej_str)

# 		inst2.write("SOURce2:BURSt ON")
# 		inst2.write("SOURce2:BURSt:INTernal:PERiod {:.9f}".format(period_burst))
# 		inst2.write("SOURce2:BURSt:MODE TRIGgered")
# 		inst2.write("SOURce2:BURSt:NCYCles 1")
# 		# inst.write("SOURce2:BURSt:TDELay {:f}".format(self.delay))
# 		inst2.write("SOURCe2:BURSt:TRIGger:SOURce EXTernal")
# 		inst2.write("SOURce2:BURSt:TRIGger:SLOPe POSitive")
...
# 		# waveform_square = np.zeros(samples)
# 		# waveform_square[:] = -1
# 		# waveform_square[np.int((self.pulse_delay_ej+self.pulse_width_ej+90E-9)/self.sampling_time):np.int((self.pulse_delay_ej+self.pulse_width_ej+90E-9+30E-9)/self.sampling_time)] = 1
# 		# # waveform_square[:] = 1
# 		# # waveform_square[0:np.int((self.pulse_delay_ao+self.pulse_width_ao+self.wait_time+self.pulse_delay_ej+self.pulse_width_ej+90E-9)/self.sampling_time)] = -1
# 		# # waveform_square[-40:] = -1
