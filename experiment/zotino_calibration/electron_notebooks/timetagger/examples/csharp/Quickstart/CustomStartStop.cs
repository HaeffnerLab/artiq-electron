...
namespace SwabianInstruments.TimeTagger.Examples
{
    ...
    class CustomStartStop : CustomMeasurement
    {
        private int _clickChannel;
        private int _startChannel;
        private long _binwidth;
        private long _last;
        private Dictionary<long, uint> _data = new Dictionary<long, uint>();
