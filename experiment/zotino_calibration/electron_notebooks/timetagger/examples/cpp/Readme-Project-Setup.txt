...
Both libraries require that the final application is linked to at least version v142 of the Visual Studio platform toolset (default in Visual Studio 2019).
