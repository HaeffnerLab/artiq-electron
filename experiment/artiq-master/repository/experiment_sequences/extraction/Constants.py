...
class Constants(HasEnvironment):
    def build(self):

        ### general
        self.setattr_argument("n_repetitions", NumberValue(default = 10000, ndecimals = 0, step = 1), group = "General", tooltip = "[ ] | Number of repeated experiment cycles") 
        ...
        ### notes on other experiment params
        self.setattr_argument("rf_power", NumberValue(default = 5, ndecimals = 1, step = 1), group = "General", tooltip = "[dBm] | power output of valon")

        ### Detection
        self.setattr_argument("t_delay", NumberValue(default = 500, ndecimals = 0, step = 1), group = "Detection", tooltip = "[ns] | delay time for the ttl input after the extraction trigger ttl")
        ...
        self.setattr_argument("trigger_level", NumberValue(default = 0.1, ndecimals = 3, step = .001, unit = 'V'), group = "Detection", tooltip = "[V] | threshold voltage for threshold detector")
    ...
    def build_DAC(self):
        ...
        self.setattr_argument("compensate_grid",BooleanValue(default = False))
