from artiq.experiment import HasEnvironment, StringValue, kernel
import numpy as np
import artiq 

class DAC_config(HasEnvironment):

    def build(self):
        self.setattr_device('core')
        self.setattr_device('zotino0')
        self.setattr_argument("c_file_csv", StringValue(default=f'{artiq.__artiq_dir__}/../../experiment/control_files/cfile_fused_DC_0p025in_FEP_Shield_Manual_0.3_Mesh_100um_0.5um_L_ROI_100um.csv'))
        self.setattr_argument("offset_file_txt", StringValue(default=f'{artiq.__artiq_dir__}/../../experiment/zotino_calibration/zotino_calibration_20260720_144139.txt'))
    ...
    def loadDACoffset(self):
        ...
        f = self.offset_file_txt #'/home/electron/artiq/experiment/zotino_calibration/zotino_calibration_3layer_smaller_spacer_with_amp.txt'
        tmp = np.loadtxt(f)
