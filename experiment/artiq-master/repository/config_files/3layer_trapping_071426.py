...
SSA_params = dict(freq_center=176.310e6,freq_span=1e6, 
                  RBW_auto=0, VBW_auto=1, SWT_auto=1, VBW_RBW_rat=1, 
                  RBW=1e3, VBW=1e3, SWT=1, N_avg=1)
Valon_params = dict(freq=1465714285, power=0)
...
voltage_map = {'bl1':0, 'bl2':0, 'bl3':0, 'bl4':0, 'bl5':0,
            ...
            'U4':0, 'U5':0}
cfile = '/home/electron/artiq/experiment/control_files/cfile_merged_electrodes.csv'
calibration_file = '/home/electron/artiq/experiment/zotino_calibration/zotino_calibration_20260713_120705.txt'
